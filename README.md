...
**一个会自我生长的生图引擎。**
你给意图，它照你的要求现写提示词，自由调度 N 模板 · 100 构图 · 383 画师 · 736 中国传统色 · 真人垫图，任意比例直出专业级画面；
...
| 层 | 是什么 | 怎么用 |
|---|---|---|
| **固有提示词** | N 个手调的完整构图模板 | `--template 诗性编辑视觉` |
...
这套生图引擎是 **Astralune** 的内部能力——N 个手调模板、383 位画师风格、736 中国传统色、任意比例直出，会按你的需求现写提示词。引擎与提示词不外发。

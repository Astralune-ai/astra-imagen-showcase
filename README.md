...
**一个会自我生长的生图引擎。**
你给意图，它照你的要求现写提示词，自由调度 67 模板 · 100 构图 · 383 画师 · 736 中国传统色 · 真人垫图，任意比例直出专业级画面；
每一条好提示词都沉淀回库，让它越用越懂你、越用越强。排版交给模型，因为它的审美足够强。

![templates](https://img.shields.io/badge/templates-67-success.svg)
...
| 层 | 是什么 | 怎么用 |
|---|---|---|
| **固有提示词** | 67 个手调的完整构图模板 | `--template 诗性编辑视觉` |
...
这是和别人最不一样的地方。astra-imagen 不只是套死模板——它内置了**母版（提示词写作配方）**：氛围类一套、重型编辑类一套。你给一个用途和一句话，它能照你的 spec **现写一条全新的、具体的提示词**，出图后还能把这条好提示词**存回库里**变成新模板。
...
这套生图引擎是 **Astralune** 的内部能力——67 个手调模板、383 位画师风格、736 中国传统色、任意比例直出，会按你的需求现写提示词。引擎与提示词不外发。
